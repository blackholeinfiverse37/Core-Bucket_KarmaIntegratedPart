...
# Bucket Integration Config (Non-invasive)
BUCKET_INTEGRATION = {
    "enabled": os.getenv("BUCKET_INTEGRATION_ENABLED", "true").lower() == "true",
    "url": os.getenv("BUCKET_URL", "http://localhost:8000"),
    "timeout": float(os.getenv("BUCKET_TIMEOUT", "2.0")),
