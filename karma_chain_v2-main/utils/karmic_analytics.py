...
def get_weekly_karma_trends(weeks: int = 4) -> Dict[str, Any]:
    ...
    try:
        ...
        # Return empty data if database unavailable
        return {
            "period": f"{weeks} weeks",
            "start_date": (datetime.now(timezone.utc) - timedelta(weeks=weeks)).isoformat(),
...
def get_live_karmic_metrics() -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "total_users": 0,
            "events_last_24h": 0,
            "dharma_points_last_24h": 0,
            "seva_points_last_24h": 0,
            "paap_tokens_last_24h": 0,
            "punya_tokens_last_24h": 0,
            "average_net_karma_sample": 0.0,
            "health_status": "database_unavailable"
        }