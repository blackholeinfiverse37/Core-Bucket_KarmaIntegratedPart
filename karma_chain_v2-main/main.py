...
from routes.v1.test_helpers import router as test_helpers_router
...
# Include test helpers (for integration testing)
app.include_router(test_helpers_router, prefix="/v1", tags=["Test Helpers"])
