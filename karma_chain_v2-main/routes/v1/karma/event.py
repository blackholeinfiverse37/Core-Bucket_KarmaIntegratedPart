...
async def unified_event_endpoint(request: UnifiedEventRequest):
    ...
    try:
        ...
        # Update database with success (with error handling)
        try:
        ...
        # Update database with HTTP error (with error handling)
        try:
            db_event.status = "failed"
        ...
        # Update database with unexpected error (with error handling)
        try:
            db_event.status = "failed"
